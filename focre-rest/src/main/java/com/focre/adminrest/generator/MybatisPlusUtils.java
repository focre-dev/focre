...
public class MybatisPlusUtils {
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://127.0.0.1:3306/fpay_master?autoReconnect=true&useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=UTC");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.focre.admin.modular");
        ...
        strategy.setNaming(NamingStrategy.underline_to_camel);// 表名生成策略
         ...
         pc.setModuleName("system.content");
